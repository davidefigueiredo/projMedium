function Banner() {
  return (
      <div className="px-10 space-y-5 flex  justify-between items-center bg-yellow-400 border-y border-black py-10 lg:py-0">
          <div>
            ...
            <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore voluptas itaque, incidunt modi consequatur</h2>
          </div>
